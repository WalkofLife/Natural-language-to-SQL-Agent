...
class SQLQuery(BaseModel):
    """Schema for SQL query solutions to question"""
...
def get_sql_gen_chain():
    ...
    sql_gen_prompt = ChatPromptTemplate.from_messages([
        (
            ...
            Answer the user's question based on the provided documentation snippets and the database scema provided below. Ensure any SQL query you provide is valid and executable\n
